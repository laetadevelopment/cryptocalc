<template>
  <div v-if="showHome" id="home" class="page">
    ...
    <div class="page-content" ref="content">
      ...
      <p>CryptoCalc is a MIT-licensed open source project built with the <a title="SSPWA Template" href="https://sspw.app">SSPWA Template</a> using Vue.js, Solidity smart contracts, and Golang microservices. End the frustration over how long it takes to convert one currency to another. The process can be excruciatingly slow when you are researching digital or crypto currencies, especially when you must start with one currency and convert it to multiple currencies before getting to the final currency. The CryptoCalc DApp will do that for you on the fly!</p>
